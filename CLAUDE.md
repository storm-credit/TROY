...
**5축**: ①공감각 정확성(감정=음악은 서준 고유 지각·능력=끝까지 비밀 world §10) ②연재체 완화(줄바꿈 파편→산문, 메모/수첩/톡방 backtick 유지) ③음악비유 밀도 규율(박자·리듬·선율 **화당 3~4회 상한**, 같은 문단 연속 금지) ④종결·감정 문법(house bible §6 잠언/슬로건/제목콜백 종결 금지, 결말 문법 불변) ⑤자연스러움(은유 사실 착지 + 호칭 캐논: 서준↔아린 존댓말·↔이든 반말).
